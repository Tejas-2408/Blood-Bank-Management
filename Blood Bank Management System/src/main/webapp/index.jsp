...
<body>
  ...
  {
  %>
  <center><font color="green" size="5">Details Submitted Successfully. You will be notified within 6 Hours</font></center>
  <%} %>
  ...
  {
  %>
  <center><font color="red" size="5">Invalid Data Entry!! Try Again</font></center>
  <%} %>
